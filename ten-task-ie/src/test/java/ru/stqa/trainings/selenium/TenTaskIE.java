 ...
 */
public class TenTaskIE extends TestBase {
    ...
    public void comparisonRegularPrice(){
        ...
        String regTextLineHP = driver.findElement(By.xpath("//div[@id='box-campaigns']//a[@class='link']//s[@class='regular-price']")).getCssValue("text-decoration");
    ...
    public void comparisonActionPrice(){
        ...
        assertTrue(actTextStyleHP.equals("700")& getRgb(actColorHP)[2].equals(getRgb(actColorHP)[1])& getRgb(actColorHP)[1].equals("0"));
